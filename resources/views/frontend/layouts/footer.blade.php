		...
		<div class="w3agile_footer_grids">
			<div class="col-md-3 agileinfo_footer_grid">
				<div class="agileits_w3layouts_footer_logo">
					<h2><a href="{{ route('home') }}"><span>台</span>南農場<i>Tainan Farm</i></a></h2>
				</div>
			</div>
...
{{--
					...
					<li><a href="{{ route('contact') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Contact Us</a></li>
--}}
				</ul>
			</div>
{{--
			<div class="col-md-3 agileinfo_footer_grid">
				...
				<div class="agileinfo_footer_grid_left">
					<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('frontend/images/6.jpg') }}" alt=" " class="img-responsive" /></a>
				</div>
				<div class="agileinfo_footer_grid_left">
					<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('frontend/images/2.jpg') }}" alt=" " class="img-responsive" /></a>
				</div>
				<div class="agileinfo_footer_grid_left">
					<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('frontend/images/5.jpg') }}" alt=" " class="img-responsive" /></a>
				</div>
				<div class="agileinfo_footer_grid_left">
					<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('frontend/images/3.jpg') }}" alt=" " class="img-responsive" /></a>
				</div>
